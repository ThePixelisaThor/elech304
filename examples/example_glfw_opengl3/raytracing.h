...
void compute_ray(vec2 tx, vec2 rx, vec2 direction, vec2 ray_origin, std::vector<Ray>& all_rays, std::vector<Wall> walls, float start_energy, float total_distance, int reflexion_left);
